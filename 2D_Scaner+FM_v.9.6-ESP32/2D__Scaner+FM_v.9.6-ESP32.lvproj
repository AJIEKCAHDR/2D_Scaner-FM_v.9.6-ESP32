...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="2D__Scaner+FM_v.9.6-ESP32.vi" Type="VI" URL="../2D__Scaner+FM_v.9.6-ESP32.vi"/>
		<Item Name="Match Regular Expression.xnode" Type="XNode" URL="/&lt;vilib&gt;/regexp/Match Regular Expression.xnode"/>
		<Item Name="Phase control (SubVI).vi" Type="VI" URL="../Phase control (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ADC esp-32 (SubVI).vi" Type="VI" URL="../ADC esp-32 (SubVI).vi"/>
			<Item Name="Check pos FM (SubVI).vi" Type="VI" URL="../Check pos FM (SubVI).vi"/>
			<Item Name="Control joystick (SubVI).vi" Type="VI" URL="../Control joystick (SubVI).vi"/>
			<Item Name="GlobalStop.vi" Type="VI" URL="../GlobalStop.vi"/>
			<Item Name="Iitialization esp-32 (SubVI).vi" Type="VI" URL="../Iitialization esp-32 (SubVI).vi"/>
			<Item Name="Initial XY (SubVI).vi" Type="VI" URL="../Initial XY (SubVI).vi"/>
			<Item Name="Initial Z (SubVI).vi" Type="VI" URL="../Initial Z (SubVI).vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="lvStorage.dll" Type="Document" URL="lvStorage.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Min phase set (SubVI).vi" Type="VI" URL="../Min phase set (SubVI).vi"/>
			<Item Name="Phase control start (SubVI).vi" Type="VI" URL="../Phase control start (SubVI).vi"/>
			<Item Name="Profile scan start (SubVI).vi" Type="VI" URL="../Profile scan start (SubVI).vi"/>
			<Item Name="Scan read phase v_2 axis (SubVI).vi" Type="VI" URL="../Scan read phase v_2 axis (SubVI).vi"/>
			<Item Name="Scan read v_2 axis (SubVI).vi" Type="VI" URL="../Scan read v_2 axis (SubVI).vi"/>
			<Item Name="Scan start (SubVI).vi" Type="VI" URL="../Scan start (SubVI).vi"/>
			<Item Name="Scan stop (SubVI).vi" Type="VI" URL="../Scan stop (SubVI).vi"/>
			<Item Name="Set position 2D (SubVI).vi" Type="VI" URL="../Set position 2D (SubVI).vi"/>
			<Item Name="Set position FM (SubVI).vi" Type="VI" URL="../Set position FM (SubVI).vi"/>
			<Item Name="Verify end axis (SubVI).vi" Type="VI" URL="../Verify end axis (SubVI).vi"/>
			<Item Name="Waiting rotate 2D (SubVI).vi" Type="VI" URL="../Waiting rotate 2D (SubVI).vi"/>
			<Item Name="Write_read_uart esp-32 (SubVI).vi" Type="VI" URL="../Write_read_uart esp-32 (SubVI).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="2D__Scaner+FM_v.9.6-ESP32" Type="EXE">
				<Property Name="App_copyErrors" Type="Bool">true</Property>
				<Property Name="App_INI_aliasGUID" Type="Str">{C9A4C2E8-9D73-41D8-AC1D-C119B6D6A575}</Property>
				<Property Name="App_INI_GUID" Type="Str">{4786515D-1607-4899-861F-9139981B11CD}</Property>
				<Property Name="App_serverConfig.httpPort" Type="Int">8002</Property>
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{905B6CC6-91DE-4670-A61B-B30425A90BC0}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">2D__Scaner+FM_v.9.6-ESP32</Property>
				<Property Name="Bld_excludeInlineSubVIs" Type="Bool">true</Property>
				<Property Name="Bld_excludeLibraryItems" Type="Bool">true</Property>
				<Property Name="Bld_excludePolymorphicVIs" Type="Bool">true</Property>
				<Property Name="Bld_localDestDir" Type="Path">../builds/NI_AB_PROJECTNAME/2D__Scaner+FM_v.9.6-ESP32</Property>
				...
				<Property Name="TgtF_fileDescription" Type="Str">2D__Scaner+FM_v.9.6-ESP32</Property>
				<Property Name="TgtF_internalName" Type="Str">2D__Scaner+FM_v.9.6-ESP32</Property>
